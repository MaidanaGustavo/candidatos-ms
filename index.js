...
const percorreBens = function(arrayBens,id){
	for(let i = 0;i<arrayBens.length;i++){
		let idBens = id*i+id;
	//console.log(arrayBens)	
	client.query(`INSERT INTO public.bens("idBens", ordem, descricao, "descricaoDeTipoDeBem", valor, "dataUltimaAtualizacao", "idCandidato")VALUES( ${idBens},${arrayBens[i].ordem},'${arrayBens[i].descricao}' , '${arrayBens[i].descricaoDeTipoDeBem}', ${arrayBens[i].valor}, '${arrayBens[i].dataUltimaAtualizacao}', ${id})`)
}
}
